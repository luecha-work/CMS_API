...
namespace Entities.Migrations
{
    ...
    [Migration("20240124121623_AccountAddActiveMigration")]
    partial class AccountAddActiveMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Roles", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4a3d4f58-52bc-46d9-8a4f-f25f514b2215",
                            Create_At = new DateTimeOffset(new DateTime(2024, 1, 24, 19, 16, 20, 962, DateTimeKind.Unspecified).AddTicks(6697), new TimeSpan(0, 7, 0, 0, 0)),
                            Create_By = "Configure",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR",
                            RoleCode = "R01",
                            Update_At = new DateTimeOffset(new DateTime(2024, 1, 24, 19, 16, 20, 962, DateTimeKind.Unspecified).AddTicks(6749), new TimeSpan(0, 7, 0, 0, 0)),
                            Update_By = ""
                        },
                        new
                        {
                            Id = "cbec45d9-2dfe-48fc-9238-e1d7cd8a7402",
                            Create_At = new DateTimeOffset(new DateTime(2024, 1, 24, 19, 16, 20, 962, DateTimeKind.Unspecified).AddTicks(6757), new TimeSpan(0, 7, 0, 0, 0)),
                            Create_By = "Configure",
                            Name = "User",
                            NormalizedName = "USER",
                            RoleCode = "R02",
                            Update_At = new DateTimeOffset(new DateTime(2024, 1, 24, 19, 16, 20, 962, DateTimeKind.Unspecified).AddTicks(6759), new TimeSpan(0, 7, 0, 0, 0)),
                            Update_By = ""
                        });
                });
